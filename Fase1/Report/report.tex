...
Para o cálculo das várias slices usamos um ângulo $\alpha$ que varia entre 0 e $2*\pi$ com o eixo do X. O ângulo de slice em slice avança: $$ SliceStep = \frac{2*\pi}{numero\_slices}\ rads$$ 
