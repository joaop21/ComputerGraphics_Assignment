...
\begin{enumerate}
 ...
 \item A partir do nodo atual, procura o primeiro filho, $\Rightarrow$ group
    \begin{enumerate}
      \item Caso não seja obtido, termina execução.
    \end{enumerate}
 \item O nodo (group) obtido no passo anterior será usado como parâmetro na função parseGroup.
\end{enumerate}
 ...
 \item Iterar sobre todos os filhos do nodo passado como parâmetro, até algum ser null:
   ...
   \begin{enumerate}
     \item Caso seja translate:
        \begin{enumerate}
          \item Obtém-se os valores e atribuem-se à figura $\Rightarrow$ X,Y,Z
        \end{enumerate}
     \item Caso seja rotate:
        \begin{enumerate}
          \item Obtém-se os valores e atribuem-se à figura $\Rightarrow$ angle,X,Y,Z
        \end{enumerate}
     ...
     \item Caso seja models:
        \begin{enumerate}
          \item Itera-se sobre os filhos existentes:
              \begin{enumerate}
                \item Obtém-se o nome do ficheiro da figura e invoca-se com esse parâmetro a função $\Rightarrow$ loadFigure
                \item Obtém-se os valores das cores e atribuem-se à figura $\Rightarrow$ R,G,B
              \end{enumerate}
        \end{enumerate}
  ...
  Função loadFigure:
    ...
    \item Caso seja group:
      \begin{enumerate}
        \item Executa-se recursivamente a função parseGroup sendo o parâmetro inicial o nodo atualmente a ser iterado.
  ...
  \item Retorna-se a Tree passada como parâmetro inicialmente, agora com as figuras e suas transformações já armazenadas.
